...
Como podemos obersarvar se nos muestra una casilla denominada curl esta es una herramienta que permite tener una respuesta detallada de una petición HTTP. Así cómo los encabezados de las de las peticiones http realizadas:
